            ...
            <section class="newsletter-subscribe">
                <div class="container">
                    <div class="intro">
                        ...
                        <p class="text-center">Your Total Payment for ULTIMATE PLAN with PowerVision is INR- 38,000/- for further payments kindly contact your booked Hotel/Banquet.Thankyou !</p>
                    </div>
                </div>
            </section>
        </div>
